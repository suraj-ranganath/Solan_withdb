var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var colors = [
    ...
    '#7E735F'];
    var
    Leaderboard = function (_React$Component) {_inherits(Leaderboard, _React$Component);
        function Leaderboard() {_classCallCheck(this, Leaderboard);var _this = _possibleConstructorReturn(this, (Leaderboard.__proto__ || Object.getPrototypeOf(Leaderboard)).call(this));
    
            _this.state = {
                leaders: [],
                maxScore: 500 };
    
            _this.getData = _this.getData.bind(_this);return _this;
        }_createClass(Leaderboard, [{ key: 'getData', value: function getData()
            {
                /* Here you can implement data fetching */
                var data = {
                    success: true,
                    leaders: [
                    { id: 1, name: 'Donald Trump', score: 350 },
                    { id: 3, name: 'Vladamir Putin', score: 275 },
                    { id: 2, name: 'Narendra Modi', score: 220 },
                    { id: 4, name: 'Theresa May', score: 200 },
                    { id: 5, name: 'Justin Trudeau', score: 175 }],
                ...
                return (
                    React.createElement('div', { className: 'Leaderboard' },
                        ...
                        React.createElement('div', { className: 'leaders' },
                            this.state.leaders ?
                            this.state.leaders.map(function (el, i) {return (
                                    React.createElement('div', {
                                        ...
                                        React.createElement('div', { style: { animationDelay: 0.4 + i * 0.2 + 's' }, className: 'leader-bar' },
                                            React.createElement('div', {
                                                style: {
                                                    backgroundColor: colors[i],
                                                    width: el.score / _this2.state.maxScore * 100 + '%' },
            ...
            } }]);return Leaderboard;}(React.Component);
